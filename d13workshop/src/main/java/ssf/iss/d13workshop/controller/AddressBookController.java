...
public class AddressBookController {
    ...
    public String saveContact(@Valid @ModelAttribute("contact") Contact conForm,
        ...
        if (conForm.getDoB().isBefore(LocalDate.now().minusYears(100)) || 
        conForm.getDoB().isAfter(LocalDate.now().minusYears(10))) {
            FieldError err = new FieldError("form", "dateOfBirth", "You cannot be younger than 10 years old and older than 100 years old!");
            result.addError(err);
        }
